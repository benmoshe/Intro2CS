 ...
 * 4.3.1 Test of po satisfies all cases in Po(i) =- it would have found the wolf in Po(I):
...
///////////////////////// Output: //////////////////////
 * Number of options (for the wolf): 8

All plays: (5^2) = 25
Solution found for (2) steps --> false

Number of options (for the wolf): 14

All plays: (5^3) = 125
Solution found for (3) steps --> false

Number of options (for the wolf): 24

All plays: (5^4) = 625
Solution found for (4) steps --> false

Number of options (for the wolf): 42

All plays: (5^5) = 3125
Solution found for (5) steps --> false

Number of options (for the wolf): 72
All plays: (5^6) = 15625
found a solution:
2,3,4,2,3,4,found a solution:
2,3,4,4,3,2,found a solution:
4,3,2,2,3,4,found a solution:
4,3,2,4,3,2,Solution found for (6) steps --> true
...
public class Wolf_5_Solution{
	public static void main(String[] a) {
		...
		while(!found) {
			opt = nextGen(opt);
			System.out.println();
			System.out.println("Number of options (for the wolf): "+opt.size());
	...
	/**
	 * Next generation of the (i+1)th possible movements from the ith generation.
	 * @param last
	 * @return
	 */
