...
public class Point2D{
	/**
	 * Standard (large) epsilon for numeriacl computation: 1/1000.
	 */
    public static final double EPS1 = 0.001;
    /**
	 * Standard (small) epsilon for numeriacl computation 10^{-6}.
	 */
    public static final double EPS2 = Math.pow(EPS1,2);
    /**
	 * Standard epsilon for numeriacl computation.
	 */
    public static final double EPS=EPS2;
    /**
	 * static final reference for the orign: [0,0].
	 */
    public static final Point2D ORIGIN = new Point2D(0,0);
    /** The private (double ) 2D cordinates */
 ...
 /**
  * returns the "rounded" int value of the x cordinate
  * @return (int)Math.round(_x)
  */
    public int ix() {return (int)Math.round(_x);}
    /**
     * returns the "rounded" int value of the y cordinate
     * @return (int)Math.round(_y)
     */
    public int iy() {return (int)Math.round(_y);}
  
    /**
     * Compute a new Point as the sum of thie Point and p.
     * @param p
     * @return
     */
